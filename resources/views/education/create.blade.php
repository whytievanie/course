        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <h2 class="optionalparth2">Op deze pagina kan u een opleiding toevoegen.</h2>
                        <form name="optionalpartstoreform" id="optionalpartstoreform" method="POST" action="{{route('education.store')}}">
                            @csrf
                            ...
                            <div>
                                <input type="text" id="crebo" name="crebo" class="inputform">
                            </div>
                            <div class="formgroupone">
                                <label for="numbertofollowcourse">Aantal te volgen keuzedelen</label>
                            </div>
                            <div>
                                <input type="number" id="numbertofollowcourse" name="numbertofollowcourse" class="inputform">
                            </div>
                            <div>
