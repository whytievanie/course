            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-jet-nav-link href="{{ route('course.educationcourseindex') }}" :active="request()->routeIs('course.course.educationcourseindex')"
                            class="homebutton">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        ...
                        @endif
                        <h2 class="optionalparth2">Op deze pagina kan u deze opleiding aanpassen.</h2>
                        <form action="{{ route('education.update', $education->id) }}" method="POST">
                            ...
                            <div>
                                <input type="text" name="name" value="{{ $education->name }}" class="inputform" placeholder="Name">
                            </div>
                            <div class="formgroupone">
                                <label for="crebo">Crebo</label>
                            </div>
                            <div>
                                <input type="text" name="crebo" value="{{ $education->crebo }}" class="inputform" placeholder="crebo">
                            </div>
                            <div class="formgroupone">
                                <label for="numbertofollowcourse">Aantal te volgen keuzedelen</label>
                            </div>
                            <div>
                                <input type="number" value="{{ $education->numbertofollowcourse }}" id="numbertofollowcourse" name="numbertofollowcourse" class="inputform">
                            </div>
                            <div>
