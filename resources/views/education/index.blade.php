        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="pagemb">
                        <h2 class="optionalparth2">Op deze pagina ziet u de opleidingen van deze school.</h2>
                        <ul class="theleaselist">
                            @foreach($educations as $education)
                                <li class="leaselist"><a href="{{route('education.show', $education ->id)}}" class="leaseslink">Opleidingnummer: {{$education->id}}</a></li>
                            @endforeach
                        </ul>
                        <a class="linkcourse" href="{{ route('education.create') }}">Een opleiding toevoegen.</a>
                    </div>
                </div>
            </div>
        </div>
