    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                De gegevens van deze opleiding.
            </h2>
        </div>
    </header>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="educationlist">
                        <h2 class="educationid">Opleidingnummer: {{$education->id}}</h2>
                        <p class="leaseinfo">Opleidingnaam: {{$education->name}}</p>
                        <p class="leaseinfo">Crebo: {{$education->crebo}}</p>
                        <p class="educationnumbertofollowcourse">Aantal te volgen keuzedelen: {{$education->numbertofollowcourse}}</p>

                        <a class="editbutton" href="{{ route('education.edit', $education->id) }}">
                            Deze opleiding aanpassen.
                        </a>
