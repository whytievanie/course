    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                De beheerdersrol kunnen geven aan een docent.
            </h2>
        </div>
    </header>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <h2 class="optionalparth2">Op deze pagina kan u de beheerdersrol geven aan een docent.</h2>
                        <form name="optionalpartstoreform" id="optionalpartstoreform" method="POST" action="{{route('admin.changeadmin')}}">
                            @csrf
                            @method('PUT')
                            <div class="formgroupone">
                                <label for="name">Naam docent</label>
                            </div>
                            <div>
                            <select name="name" class="inputform">
                            ...
                            <label>
                                <input class="inputform" type="checkbox" name="adminid"  value="1"> 1
                            </label>
                            <div>
