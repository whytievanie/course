        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="pagemb">
                        <h2 class="optionalparth2">Op deze pagina ziet u de keuzedelen van deze school.</h2>
                        <ul class="theleaselist">
                            @foreach($courses as $course)
                                <li class="leaselist"><a href="{{route('course.show', $course ->id)}}" class="leaseslink">keuzedeelnummer: {{$course->id}}</a> </li>
                            @endforeach
                        </ul>
                        <a class="linkcourse" href="{{ route('course.create') }}">Een keuzedeel toevoegen.</a>
                    </div>
                </div>
            </div>
        </div>
