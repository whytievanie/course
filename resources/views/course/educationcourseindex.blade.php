    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                De keuzedeelopleidingkoppellijst
            </h2>
        </div>
    </header>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="pagemb">
                        <h2 class="optionalparth2">Op deze pagina kun u de keuzedeelopleidingkoppelnummer zien.</h2>
                        <ul class="theleaselist">
                            @foreach($educationcourses as $educationcourse)
                                <li class="leaselist"><a href="{{route('course.educationcourseshow', $educationcourse ->id)}}" class="leaseslink">keuzedeelnummer: {{$educationcourse->id}}</a> </li>
                            @endforeach
                        </ul>
                        <a class="linkcourse" href="{{ route('course.linkcoursepage') }}">Een keuzedeel koppelen aan een of meerdere opleidingen</a>
                    </div>
                </div>
            </div>
        </div>
