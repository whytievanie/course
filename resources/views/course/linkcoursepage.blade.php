    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Een keuzedeel koppelen aan een of meerdere opleidingen
            </h2>
        </div>
    </header>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <h2 class="optionalparth2">Op deze pagina kan u een keuzedeel koppelen aan een of meerdere opleidingen</h2>
                        <form name="optionalpartstoreform" id="optionalpartstoreform" method="POST" action="{{route('course.linkcourse')}}">
                            @csrf
                            @method('PUT')
                            <div class="formgroupone">
                                <label for="course_id">Naam keuzedeel</label>
                            </div>
                            <div>
                                <select name="course_id" class="inputform">
                                    @foreach(\App\Models\Course::select('name', 'id')->get() as $course)
                                        <option value="{{ $course->id }}">{{ $course->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="formgroupone">
                                <label for="education_id">Naam opleiding</label>
                            </div>
                            <div>
                                <select name="education_id" class="inputform">
                                    @foreach(\App\Models\Education::select('name', 'id')->get() as $education)
