    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                De gegevens van deze keuzedeelopleidingkoppelnummer.
            </h2>
        </div>
    </header>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="educationlist">
                        <h2 style="margin-top:20px; font-weight:bold; font-size:1.5rem;">
                            De gegevens van deze keuzedeelopleidingkoppelnummer.
                        </h2>
                        @foreach(\App\Models\Educationcourse::all() as $educationcourse)
                            <h2 style="margin-top:20px; font-weight:bold; font-size:1rem;">
                                Keuzedeelopleidingkoppelnummer: {{$educationcourse->id}}
                            </h2>
                            <p class="leaseinfo">Keuzedeelnummer: {{$educationcourse->course_id}}</p>
                            <p class="leaseinfo" style="margin-bottom:20px;">Opleidingnummer: {{$educationcourse->education_id}}</p>
                        @endforeach
                    </div>
                </div>
            </div>
