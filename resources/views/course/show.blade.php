    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                De gegevens van deze keuzedeel.
            </h2>
        </div>
    </header>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="educationlist">
                        <h2 class="educationid">Keuzedeelnummer: {{$course->id}}</h2>
                        <p class="leaseinfo">Keuzedeelnaam: {{$course->name}}</p>
                        <p class="leaseinfo">Aantal SBU: {{$course->SBU}}</p>
                        <p class="leaseinfo">Gebruikersnummer: {{$course->user_id}}</p>
                        <p class="educationnumbertofollowcourse">Beschrijving: {{$course->description}}</p>

                        <a class="editbutton" href="{{ route('course.edit', $course->id) }}">
                            Deze keuzedeel aanpassen.
                        </a>
                        ...
                        <form action="{{ route('course.destroy', $course->id) }}}" method="POST">
                            ...
                            <button type="submit" title="delete" class="buttondelete">
                                Een keuzedeel verwijderen
                            </button>
                        </form>
                    </div>
                </div>
