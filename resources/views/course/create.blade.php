        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <h2 class="optionalparth2">Op deze pagina kan u een keuzedeel toevoegen.</h2>
                        <form name="optionalpartstoreform" id="optionalpartstoreform" method="POST" action="{{route('course.store')}}">
                            @csrf
                            ...
                            <div>
                                <input type="number" id="SBU" name="SBU" class="inputform">
                            </div>
                            <div class="formgroupone">
                            ...
                            <div>
                                <textarea class="inputform" id="description" name="description" rows="4" cols="50"></textarea>
                            </div>
                            <div>
